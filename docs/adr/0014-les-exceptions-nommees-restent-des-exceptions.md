...
- **Plan sur le long terme.** Un chasseur peut mémoriser une face réellement
  lancée, y compris grâce à un Groove prêté par Jam !, puis choisir de l'ajouter
  une fois à un Test ultérieur. Elle compte normalement au score, n'est pas
  écartée par un désavantage et ne survit ni à Quitte ou double ni au solde de la
  session.
